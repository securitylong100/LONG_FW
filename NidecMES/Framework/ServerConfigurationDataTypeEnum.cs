...
namespace Com.Nidec.Mes.Framework
{
    public class ServerConfigurationDataTypeEnum
    {
        ...
        public static readonly ServerConfigurationDataTypeEnum MANDATORY_CHECK = new ServerConfigurationDataTypeEnum("MANDATORY_CHECK");
        ...
        public static readonly ServerConfigurationDataTypeEnum DEFAULT_MANDATORY_CHECK_XML = new ServerConfigurationDataTypeEnum("DEFAULT_MANDATORY_CHECK_XML");
