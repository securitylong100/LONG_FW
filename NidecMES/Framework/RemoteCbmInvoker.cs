   ...
   public class RemoteCbmInvoker
    {
        ...
        private static RemoteCbmInvokerProxy GetRemoteCbmInvokerProxyObject()
        {
            ...
            serverurl.Append(ServerConfigurationDataTypeEnum.DEFAULT_REMOTE_MES_SERVER_HOST_IP.GetValue());
            serverurl.Append(":");
            serverurl.Append(ServerConfigurationDataTypeEnum.DEFAULT_REMOTE_MES_SERVER_HOST_PORT.GetValue());
            serverurl.Append("/");
