...
namespace Com.Nidec.Mes.PQMConnector_Client.Dao
{
    class GetMaterialDao : AbstractPQMDataAccessObject
    {
        public override ValueObject Execute(TransactionContext trxContext, ValueObject vo)
        {
            ...
            pqmParameter.AddParameter("from", inVo.StartTime.ToString("yyyyMMddHHssmm")); // "20170101000000");
            pqmParameter.AddParameter("to", inVo.FinishTime.ToString("yyyyMMddHHssmm")); // "20181231235959");
