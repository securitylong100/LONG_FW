    ...
    public partial class AddEquipmentForm
    {
        ...
        private void LoadUserData(EquipmentVo dgvData)
        {
            if (dgvData != null)
            {
                ...
                InstrationDate_dtp.Text = dgvData.InstrationDate.ToString("yyyy-MM-dd");
        ...
        private void Ok_btn_Click(object sender, EventArgs e)
        {
            ...
            if (CheckMandatory())
            {
                ...
                if (string.Equals(mode, CommonConstants.MODE_ADD))
                {
                    ...
                    {
                        messageData = new MessageData("mmce00001", Properties.Resources.mmce00001, EquipmentName_lbl.Text + " : " + EquipmentCode_txt.Text);
                        logger.Info(messageData);
                        popUpMessage.ConfirmationOkCancel(messageData, Text);
