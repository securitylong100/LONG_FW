...
{
    public partial class AddLocalUserMasterForm
    {
        ...
        /// </summary>
        private static readonly CommonLogger logger = CommonLogger.GetInstance(typeof(AddLocalUserMasterForm));
        ...
        public AddLocalUserMasterForm(string pmode, UserVo userVo = null)
        {
            InitializeComponent();
        ...
        private void LoadUserData(UserVo userInVo)
        {
            if (userInVo != null)
            {
                ...
                if (!string.IsNullOrEmpty(userInVo.PassWord)) { Password_txt.Text = encryptDecrypt.Decrypt(userInVo.PassWord); }
