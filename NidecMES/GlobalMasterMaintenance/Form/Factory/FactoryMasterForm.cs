...
namespace Com.Nidec.Mes.GlobalMasterMaintenance
{
    public partial class FactoryMasterForm
    {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FactoryDetails_dgv_CellClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FactoryDetails_dgv_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (FactoryDetails_dgv.SelectedRows.Count > 0)
            {
                BindUpdateFactoryData();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FactoryDetails_dgv_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
