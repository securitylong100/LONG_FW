...
namespace Com.Nidec.Mes.GlobalMasterMaintenance.Dao
{
    public class AddProdutionWorkContentDao : AbstractDataAccessObject
    {
        public override ValueObject Execute(TransactionContext trxContext, ValueObject vo)
        {
            ...
            sql.Append("insert into m_prodution_work_content(prodution_work_content_cd,prodution_work_content_name,display_order,remark,prodution_work_content_type_id,registration_user_cd,registration_date_time,factory_cd) ");
            sql.Append("values(:prodution_work_content_cd,:prodution_work_content_name,:display_order,:remark,:prodution_work_content_type_id,:registration_user_cd,now(),:factory_cd)");
