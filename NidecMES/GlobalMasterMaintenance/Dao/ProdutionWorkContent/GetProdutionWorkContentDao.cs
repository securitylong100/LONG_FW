...
namespace Com.Nidec.Mes.GlobalMasterMaintenance.Dao
{
    public class GetProdutionWorkContentDao : AbstractDataAccessObject
    {
        public override ValueObject Execute(TransactionContext trxContext, ValueObject vo)
        {
            ...
            sql.Append("select prodution_work_content_id,prodution_work_content_cd,prodution_work_content_name,remark,display_order,prodution_work_content_type_id,registration_user_cd,registration_date_time,factory_cd from m_prodution_work_content");
            ...
            {
                sql.Append(" and prodution_work_content_cd = :prodution_work_content_cd ");
            ...
            sql.Append(" order by  prodution_work_content_type_id,display_order ");
            ...
            while (dataReader.Read())
            {
                ...
                {
                    ProdutionWorkContentCode = dataReader["prodution_work_content_cd"].ToString(),
