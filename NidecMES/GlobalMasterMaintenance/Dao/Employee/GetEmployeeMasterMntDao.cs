...
namespace Com.Nidec.Mes.GlobalMasterMaintenance.Dao
{
    public class GetEmployeeMasterMntDao : AbstractDataAccessObject
    {
        public override ValueObject Execute(TransactionContext trxContext, ValueObject arg)
        {
            ...
            //create SQL
            sqlQuery.Append("Select em.employee_cd, em.employee_name");
            ...
            while (dataReader.Read())
            {
                ...
                {
                    EmployeeCode = ConvertDBNull<string>(dataReader, "employee_cd"),
                    EmployeeName = ConvertDBNull<string>(dataReader, "employee_name"),
                };
